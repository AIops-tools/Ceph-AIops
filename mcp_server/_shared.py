...
from ceph_aiops import __version__
from ceph_aiops.config import load_config
from ceph_aiops.connection import CephApiError, ConnectionManager
from ceph_aiops.governance import mark_unknown, sanitize

logger = logging.getLogger(__name__)

_DOCTOR_HINT = "Run 'ceph-aiops doctor' to verify connectivity and credentials."
...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "capacity forecasting. Guarded writes cover the ops operators fear most — "
...
def _get_connection(target: Optional[str] = None) -> Any:
    """Return a Ceph connection, lazily initialising the manager."""
    global _conn_mgr  # noqa: PLW0603
    if _conn_mgr is None:
        config_path_str = os.environ.get("CEPH_AIOPS_CONFIG")
