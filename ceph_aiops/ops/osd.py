...
def _norm_osd(raw: dict) -> dict:
    ...
    return {
        ...
        "host": s(raw.get("host") or (raw.get("tree") or {}).get("host")),
        "deviceClass": s(raw.get("device_class")),
    }
...
def set_cluster_flag(conn: Any, flag: str, enable: bool = True) -> dict:
    """[WRITE][low] Set/unset a cluster flag (noout/nobackfill/norecover/noscrub/…).
