"""ceph-aiops — governed Ceph cluster operations for AI agents.
...
``ceph_aiops.governance`` — this package has no external skill-family
...
try:
    __version__ = version("ceph-aiops")
